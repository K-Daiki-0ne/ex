...
describe('Test Upload URL determination based on file type.', () => {
  it('Update text file endpoint test', () => {
    ...
    const sucTxtFileUpdEndPoint: string = 'http://localhost:5050/app/update/text?fileID=12345&title=title&comment=commnet';
  ...
  it('Update image file endpoint test', () => {
    ...
    const sucImgFileUpdEndPoint: string = 'http://localhost:5050/app/update/image?fileID=12345&title=title&comment=commnet';
  ...
  it('Update PDF file endpoint test', () => {
    ...
    const sucPDFFileUpdEndPoint: string = 'http://localhost:5050/app/update/pdf?fileID=12345&title=title&comment=commnet';
